...
def login_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                "/upload/"
            )  # after the user logs in, send them to the homepage
...
def upload_image(request):
    ...
    # else it is a GET request, meaning the user is requesting the page, in
    # which we should give them an empty form
    else:
    ...
    return render(
        ...
        "results.html",
        {
            "species_results": species_results[
                :6
            ],  # Ensure 5 species + Genus are displayed
