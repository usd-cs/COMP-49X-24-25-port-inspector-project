...
class SpecimenUpload(models.Model):
    ...
    genus_result = models.JSONField(default=list)  # Stores [genus_id, confidence_level]
    species_results = models.JSONField(default=list)  # Stores list of (species id, confidence level) tuples
